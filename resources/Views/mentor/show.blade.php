                        ...
                        <form class="row g-3" action="{{ route('mentor.update', $mentor->id) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" value="{{$mentor->kode_mentor}}" name="kd_mentor" class="form-control" id="kd_mentor" placeholder="Your Name" readonly>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="number" value="{{$mentor->no_telepon}}" name="no_telp" class="form-control" id="no_telp" placeholder="Your Email" readonly>
